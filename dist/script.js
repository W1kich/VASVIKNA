...
/* harmony export */ });
/* harmony import */ var _cheackNumInputs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cheackNumInputs */ "./src/js/modules/cheackNumInputs.js");
...
const changeModalState = state => {
  ...
  (0,_cheackNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('#width');
  (0,_cheackNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('#height');
        ...
        switch (item.nodeName) {
          ...
          case 'INPUT':
            if (item.getAttribute('type') === 'checkbox') {
              i === 0 ? state[prop] = 'Холдне' : state[prop] = 'Тепле';
              elem.forEach((box, j) => {
                box.checked = false;
                if (i === j) {
                  box.checked = true;
...
/***/ "./src/js/modules/cheackNumInputs.js":
/*!*******************************************!*\
  !*** ./src/js/modules/cheackNumInputs.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
const cheackNumInputs = selector => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (cheackNumInputs);
...
const forms = state => {
  ...
  (0,_cheackNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])(`input[name="user_phone"]`);
  const message = {
  ...
  form.forEach(item => {
    item.addEventListener('submit', e => {
      ...
      postData('assets/server.php', fromData).then(res => {
        console.log(res);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
const tabs = function (headerSelctor, tabSelector, contentSelector, activeClass) {
  let displayType = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'block';
...
const timer = (id, deadline) => {
  ...
  const setClock = (selector, endTime) => {
    const timer = document.querySelector(selector),
      ...
      seconds = timer.querySelector('#minutes'),
